    ...
    <div class="container">
        ...
        <header class="header">
            ...
            <div class="nav-bar">
                ...
                <span id="bt-home" class="nav-bar-item icon-home"></span>
            ...
            <nav id="navigator" class="navigator">
                ...
                <a class="menu-item" href="/articulos/"><span class="icon-book"></span>Artículos</a>
                <a class="menu-item" href="/proyectos/"><span class="icon-bowl"></span>Proyectos</a>
