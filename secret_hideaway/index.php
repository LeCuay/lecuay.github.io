...
<head>
    ...
    <link rel="stylesheet" href="css/secret_hideaway.min.css">
    ...
    <div class="container">
        ...
        <header class="header">
            ...
            <div class="nav-bar">
                ...
                <form class="search_section" action="/contacto/" method="get">
        ...
        <main class="main">
            <h2 class="title">Un lugar donde esconderme</h2>
            <?php
                $files = array_diff(scandir("gif"), array('.', '..'));
                echo "<img id='gif_player' src='gif/", $files[array_rand($files)], "'>\n";
            ?>
            <?php
                $music = array_diff(scandir("audio"), array('.', '..'));
                echo "<audio src='audio/", $music[array_rand($music)], "' type='audio/mpeg' autoplay loop>";
                echo "</audio>\n";
            ?>
        </main>
